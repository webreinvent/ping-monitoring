<template>
  <Teleport to="body">
    ...
    >
      ...
      >
        <h3 id="del-client-title" class="modal-title">Delete this client?</h3>
        <p class="modal-body">
          You're about to delete
          <strong>{{ clientName }}</strong>
          and <strong>{{ monitorCount }}</strong>
          {{ monitorCount === 1 ? "monitor" : "monitors" }} belonging to it.
        </p>
        <p class="modal-warning">
          This will permanently remove every monitor, all ping history,
          samples, and rollups for this client. This cannot be undone.
        </p>
